                ...
                function ($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('basketballApp.httpError', function (event, httpResponse) {
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-basketballApp-error');
                                var entityKey = httpResponse.headers('X-basketballApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('basketballApp.' + fieldError.objectName + '.' + convertedField);
